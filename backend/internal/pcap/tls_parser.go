...
func (t tlsInfo) Parse() (*string, *string, *string, bool, bool, bool, *int) {
	var sni *string
	var version *string
	var alpn *string
	clientHello := false
	...
	return sni, version, alpn, clientHello, serverHello, alert, alertCode
}
